...
<body id="page-top">
    <div id="wrapper">
            ...
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light mt-4" id="accordionSidebar">
                    <li class="nav-item" role="presentation">
                        <a class="mt-3" href="#">
                            <span class="btn text-light" style="background: tomato;">Supprimer Classe</span>
                        </a>
                    </li>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container-fluid">
                <h3 class="text-dark mb-4 text-center">Gestion des Classes</h3>
                            ...
                            <table class="table dataTable my-0 table-striped table-bordered" id="dataTable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>2008/11/28</td>
                                        <td>
                                            <a href="#" class="btn-outline-secondary btn p-2 fa fa-eye"></a>
                                            <a href="#" class="btn-outline-primary btn p-2 fa fa-edit"></a>
                                            <a href="#" class="btn-outline-danger btn p-2 fa fa-trash-alt"></a>
                                        </td>
                                    </tr>
